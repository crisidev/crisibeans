...
" ============
    ...
    if !g:crisibeans_syntax_print_as_function
        syn keyword pythonStatement print
    endif

    if g:crisibeans_syntax_highlight_async_await
    ...
    if g:crisibeans_syntax_highlight_equal_operator
        syn match pythonExtraOperator "\%(=\)"
    endif

    if g:crisibeans_syntax_highlight_stars_operator
        syn match pythonExtraOperator "\%(\*\|\*\*\)"
    endif
    
    if g:crisibeans_syntax_highlight_self
...
" ==========
    ...
    if g:crisibeans_syntax_indent_errors
        syn match pythonIndentError "^\s*\( \t\|\t \)\s*\S"me=e-1 display
    endif

    " Trailing space errors
    if g:crisibeans_syntax_space_errors
...
" ===========
    ...
    " String formatting
    if g:crisibeans_syntax_string_formatting
        syn match pythonStrFormatting   "%\(([^)]\+)\)\=[-#0 +]*\d*\(\.\d\+\)\=[hlL]\=[diouxXeEfFgGcrs%]" contained containedin=pythonString,pythonUniString,pythonRawString,pythonUniRawString
        syn match pythonStrFormatting   "%[-#0 +]*\(\*\|\d\+\)\=\(\.\(\*\|\d\+\)\)\=[hlL]\=[diouxXeEfFgGcrs%]" contained containedin=pythonString,pythonUniString,pythonRawString,pythonUniRawString
    endif

    " Str.format syntax
    if g:crisibeans_syntax_string_format
    ...
    " String templates
    if g:crisibeans_syntax_string_templates
    ...
    " DocTests
    if g:crisibeans_syntax_doctests
        syn region pythonDocTest    start="^\s*>>>" end=+'''+he=s-1 end="^\s*$" contained
        syn region pythonDocTest2   start="^\s*>>>" end=+"""+he=s-1 end="^\s*$" contained
    endif

    " DocStrings
    if g:crisibeans_syntax_docstrings
...
" ============
    ...
    if g:crisibeans_syntax_builtin_objs
        syn keyword pythonBuiltinObj True False Ellipsis None NotImplemented
        syn keyword pythonBuiltinObj __debug__ __doc__ __file__ __name__ __package__
    endif
    
    if g:crisibeans_syntax_builtin_types    
    ...
    " Builtin functions
    if g:crisibeans_syntax_builtin_funcs
    ...
    if g:crisibeans_syntax_highlight_exceptions
...
if g:crisibeans_syntax_slow_sync
